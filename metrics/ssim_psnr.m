...
folder1 ='/media/zeyu/108511CA108511CA/BID/results/task2a/test_latest/images/fake_A';
% The folder to real images.
folder2= '/media/zeyu/108511CA108511CA/BID/results/task2a/test_latest/images/real_A';
files1 = dir(folder1);
files2 = dir(folder2);
